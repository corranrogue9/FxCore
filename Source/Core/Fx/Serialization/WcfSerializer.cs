namespace Fx.Serialization
{
    ...
    public sealed class WcfSerializer : ISerializer
    {
        /// <summary>
        /// The singleton instance of the <see cref="WcfSerializer"/> that uses the default UTF8 encoding
        /// </summary>
        private static readonly WcfSerializer Singleton = new WcfSerializer(Encoding.UTF8);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WcfSerializer"/> class
        /// </summary>
        /// <param name="encoding">The <see cref="Encoding"/> that should be used when the resulting <see cref="WcfSerializer"/> interacts with <see cref="string"/>s</param>
        private WcfSerializer(Encoding encoding)
        {
            this.encoding = encoding;
        }

        /// <summary>
        /// Gets the singleton instance of the <see cref="WcfSerializer"/> that uses the UTF8 encoding
        /// </summary>
        public static WcfSerializer Default
        {
            get
            {
                return Singleton;
        ...
        /// <summary>
        /// Generates an instance of the <see cref="WcfSerializer"/> that uses the <see cref="Encoding"/> <paramref name="encoding"/> when interacting with <see cref="string"/>s
        /// </summary>
        /// <param name="encoding">The <see cref="Encoding"/> to use when the resulting <see cref="WcfSerializer"/> interacts with <see cref="string"/>s</param>
        /// <returns>An instance of the <see cref="WcfSerializer"/></returns>
        /// <exception cref="System.ArgumentNullException">Thrown if <paramref name="encoding"/> is null</exception>
        public static WcfSerializer Create(Encoding encoding)
        {
            ...
            return new WcfSerializer(encoding);
        }
        ...
        public T FromBytes<T>(byte[] toDeserialize)
        {
            ...
            return GenericWcfSerializer<T>.Default.FromBytes(toDeserialize);
        }
        ...
        public T FromStream<T>(Stream toDeserialize)
        {
            ...
            return GenericWcfSerializer<T>.Default.FromStream(toDeserialize);
        }
        ...
        public T FromString<T>(string toDeserialize)
        {
            ...
            return GenericWcfSerializer<T>.Default.FromString(toDeserialize, this.encoding.Clone() as Encoding);
        }
        ...
        public byte[] ToBytes<T>(T toSerialize)
        {
            ...
            return GenericWcfSerializer<T>.Default.ToBytes(toSerialize);
        }
        ...
        public Stream ToStream<T>(T toSerialize)
        {
            ...
            return GenericWcfSerializer<T>.Default.ToStream(toSerialize);
        }
        ...
        public string ToString<T>(T toSerialize)
        {
            ...
            return GenericWcfSerializer<T>.Default.ToString(toSerialize, this.encoding.Clone() as Encoding);
        }

        /// <summary>
        /// A generic implementation of the WCF serializer
        /// </summary>
        /// <typeparam name="T">The type of objects that this <see cref="GenericWcfSerializer{T}"/> can serialize</typeparam>
        /// <threadsafety static="true" instance="true"/>
        private sealed class GenericWcfSerializer<T>
        {
            /// <summary>
            /// A singleton instance of the <see cref="GenericWcfSerializer{T}"/>
            /// </summary>
            private static readonly GenericWcfSerializer<T> Singleton = new GenericWcfSerializer<T>();

            /// <summary>
            /// The <see cref="DataContractSerializer"/> that should be used when actually performing serializations for the <typeparamref name="T"/> type
            /// </summary>
            private readonly DataContractSerializer serializer;

            /// <summary>
            /// Prevents a default instance of the <see cref="GenericWcfSerializer{T}"/> class from being created
            /// </summary>
            private GenericWcfSerializer()
            {
                this.serializer = new DataContractSerializer(typeof(T));
            }

            /// <summary>
            /// Gets a singleton instance of the <see cref="GenericWcfSerializer{T}"/>
            /// </summary>
            public static GenericWcfSerializer<T> Default
            {
                get
                {
                    return Singleton;
            ...
            public T FromStream(Stream toDeserialize)
            {
                try
                {
                    return (T)this.serializer.ReadObject(toDeserialize);
                }
                catch (XmlException e)
                {
                    throw new SerializationException(Strings.WcfSerializerDeserialization, e);
                }
            }
            ...
            private ChunkedMemoryStream ToStreamImpl(T toSerialize)
            {
                ...
                try
                {
                    ...
                    this.serializer.WriteObject(stream, toSerialize);
                    stream.Position = 0;
                    return stream;
                }
                catch
