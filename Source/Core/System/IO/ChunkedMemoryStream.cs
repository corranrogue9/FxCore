namespace System.IO
{
    ...
    public sealed class ChunkedMemoryStream : Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Strings.ChunkedMemoryStreamRead, count, offset, buffer.Length));
            }
        ...
        public override void SetLength(long value)
        {
            ...
            if (!this.writable)
            {
                throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, Strings.ChunkedMemoryStreamSetLength));
            }
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            if (buffer.Length - offset < count)
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Strings.ChunkedMemoryStreamWriteSize, count, offset, buffer.Length));
            }
            ...
            if (!this.writable)
            {
                throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, Strings.ChunkedMemoryStreamWriteSupport));
            }
